...
function HirimiLib:MakeNotify(NotifyConfig)
	...
	spawn(function()
		...
		TextLabel1.Position = UDim2.new(0, 200, 0, 0)
...
function HirimiLib:MakeGui(GuiConfig)
	local GuiConfig = GuiConfig or {}
	GuiConfig.Name = GuiConfig.Name or "Hirimi Hub"
	...
	GuiConfig.Size = GuiConfig.Size or UDim2.new(0, 500, 0, 400)
	local GuiFunc = {}
	...
	DropShadow.BorderSizePixel = 0
	DropShadow.Position = UDim2.new(0.5, 0, 0.5, 0)
	DropShadow.Size = GuiConfig.Size
	DropShadow.ZIndex = 0
	DropShadow.Name = "DropShadow"
	DropShadow.Parent = DropShadowHolder
	...
	TextLabel1.BorderColor3 = Color3.fromRGB(0, 0, 0)
	TextLabel1.BorderSizePixel = 0
	TextLabel1.Size = UDim2.new(0.6, 0, 0.6, 0)
	TextLabel1.Position = UDim2.new(0, TextLabel.TextBounds.X + 25, 0.3, 0)
	TextLabel1.Parent = Top
	...
	Layers.Position = UDim2.new(0, 120 + 18, 0, 50)
	Layers.Size = UDim2.new(1, -(120 + 9 + 18), 1, -59)
	Layers.Name = "Layers"
	Layers.Parent = Main
	...
	MaxRestore.MouseButton1Down:Connect(function()
		...
		if ImageLabel.Image == "rbxassetid://9886659406" then
			...
			TweenService:Create(DropShadow, TweenInfo.new(0.3), {Size = UDim2.new(1, 0, 1, 0)}):Play()
			TweenService:Create(Main, TweenInfo.new(0.3), {Size = UDim2.new(1, 0, 1, 0)}):Play()
		else
			ImageLabel.Image = "rbxassetid://9886659406"
			...
			TweenService:Create(DropShadow, TweenInfo.new(0.3), {Size = OldSize}):Play()
			TweenService:Create(Main, TweenInfo.new(0.3), {Size = OldSize}):Play()
		end
	end)
			...
			local function UpdateSizeSection()
				if OpenSection then
					...
					for i, v in SectionAdd:GetChildren() do
						if v.Name ~= "UICorner" and v.Name ~= "UIListLayout" then
				...
				function ToggleFunc:Set(Value)
					...
					if Value then
						...
						TweenService:Create(
							UIStroke8,
							TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),
							{Color = Color3.fromRGB(0, 0, 0), Transparency = 0.9}
						):Play()
						TweenService:Create(
							FeatureFrame2,
							TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut),
			...
			function Items:AddDropdown(DropdownConfig)
				...
				DropdownButton.MouseButton1Click:Connect(function()
					if not MoreBlur.Visible then
						...
						DropPageLayout:JumpToIndex(CountDropdown)
				...
				function DropdownFunc:AddOption(OptionName)
					...
					UIStroke15.Color = Color3.fromRGB(255, 255, 255)
	...
	TextLabel.BorderColor3 = Color3.fromRGB(0, 0, 0)
	TextLabel.BorderSizePixel = 0
	TextLabel.Position = UDim2.new(0.139807895, 0, 0.296437651, 0)
	TextLabel.Size = UDim2.new(0, 620, 0, 319)
