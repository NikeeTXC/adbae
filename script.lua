...
if not _G.httpRequest then
    ...
    local v3 = "NikeeHUB/FishIt" .. "/Position.json";
    local v4 = {
    ...
    TeleportLastPos = function(v61) --[[ Line: 0 ]] --[[ Name:  ]]
        task.spawn(function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v63 then
                ...
                nikeehub("Teleported to your last position...");
            end;
        end);
    end;
            ...
            task.spawn(function() --[[ Line: 0 ]] --[[ Name:  ]]
                ...
                if v122 then
                    if v8.curCF then
                        ...
                        task.wait(0.5);
                        v70(v121, true);
                        nikeehub("Respawn \226\134\146 Back");
                    elseif v8.origCF then
                        v121:PivotTo(v8.origCF);
                        v70(v121, false);
                        v81(v121, v122, true);
                        nikeehub("Back to farm");
                    end;
                end;
            end);
        end;
    ...
    nikeehub = function(msg, duration) --[[ Line: 0 ]] --[[ Name:  ]]
        -- Custom NikeeHUB notification function
        if v137 and v137.Notify then
            v137:Notify({Title = "NikeeHUB", Content = msg, Duration = duration or 3});
        else
            print("[NikeeHUB] " .. tostring(msg));
        end;
    end;
    local v137 = loadstring(game:HttpGet("https://raw.githubusercontent.com/NikeeTXC/adbae/refs/heads/main/Library"))():Window({
        Title = "NikeeHUB |",
        Footer = "Version 1.0.0 - by Nikee",
        Image = "https://tr.rbxcdn.com/81840624411657/150/150/Image/Png",
        Color = Color3.fromRGB(0, 139, 139),
        Theme = 9542022979,
        Version = 3
    });
    if v137 then
        nikeehub("Window loaded!");
    end;
    local v138 = {
        Info = v137:AddTab({
            Name = "Info", 
    ...
    local v139 = "https://raw.githubusercontent.com/NikeeTXC/adbae/refs/heads/main/2.lua";
                        ...
                        while v8.supportEnabled do
                            ...
                            if not l_status_5 or not l_result_5 then
                                ...
                                elseif v8.fishingTimer >= (v8.stuckThreshold or 10) then
                                    ...
                                    l_l_v8_3_0 = "255,69,0";
                                    nikeehub("Fishing Stuck! Resetting...", 3);
    ...
    Fish:AddButton({
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            pcall(function() --[[ Line: 0 ]] --[[ Name:  ]]
                -- upvalues: v6 (ref)
                v6.Functions.Cancel:InvokeServer();
                nikeehub("Recovery Successfully!");
            end);
        end
    });
    ...
    v228:AddToggle({
        ...
        Callback = function(v254) --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v254 then
                ...
                if game.CoreGui:FindFirstChild("NikeeHUB_FishingPanel") then
                    game.CoreGui:FindFirstChild("NikeeHUB_FishingPanel"):Destroy();
                end;
                local l_ScreenGui_0 = Instance.new("ScreenGui");
                l_ScreenGui_0.Name = "NikeeHUB_FishingPanel";
                ...
                v260.Text = "NIKEEHUB PANEL FISHING";
                v260.TextSize = 22;
                ...
                local l_NikeeHUB_FishingPanel_0 = game.CoreGui:FindFirstChild("NikeeHUB_FishingPanel");
                if l_NikeeHUB_FishingPanel_0 then
                    l_NikeeHUB_FishingPanel_0:Destroy();
                end;
            end;
        end
    });
    v228:AddToggle({
        ...
        Callback = function(v281) --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v281 then
                if l_CoreGui_0:FindFirstChild("NikeeHUB_BlackScreen") then
                    l_CoreGui_0.NikeeHUB_BlackScreen:Destroy();
                end;
                local l_ScreenGui_1 = Instance.new("ScreenGui");
                l_ScreenGui_1.Name = "NikeeHUB_BlackScreen";
    ...
    v348:AddButton({
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v350 then
                ...
                nikeehub("Position saved successfully!");
            end;
        end, 
        ...
        SubCallback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            nikeehub("Last position has been reset.");
        end
    });
    ...
    local function v430(v427) --[[ Line: 0 ]] --[[ Name:  ]]
        ...
        if not v427 then
            ...
            if not l_status_8 then
                warn("[NikeeHUB] Totem spawn failed:", tostring(l_result_8));
            end;
            return;
        end;
    end;
    ...
    local function v519(v511, v512, v513, v514) --[[ Line: 0 ]] --[[ Name:  ]]
        ...
        if not l_FirstChild_1 then
            ...
            if v513 then
                v501("Sending");
                nikeehub("Sending " .. v513);
            else
                v506("Sending");
                nikeehub("Sending fish for coins");
            end;
    ...
    startTradeByName = function() --[[ Line: 0 ]] --[[ Name:  ]]
        ...
        elseif not l_trade_4.selectedPlayer or not l_trade_4.selectedItem then
            return nikeehub("Select player & item first!");
        else
            l_trade_4.trading = true;
            l_trade_4.successCount = 0;
            nikeehub("Starting trade with " .. l_trade_4.selectedPlayer);
            ...
            if not v528 then
                ...
                return nikeehub("Item not found");
            else
    ...
    startTradeByCoin = function() --[[ Line: 0 ]] --[[ Name:  ]]
        ...
        elseif not l_trade_5.selectedPlayer or l_trade_5.targetCoins <= 0 then
            return nikeehub("\226\154\160 Select player & coin target first!");
        else
            ...
            nikeehub("Starting coin trade with " .. l_trade_5.selectedPlayer);
            ...
            if #v541 == 0 then
                ...
                nikeehub("\226\154\160 No fishes found in inventory");
                return;
            else
                ...
                if #v548 == 0 then
                    ...
                    if not v0.Players:FindFirstChild(l_trade_5.selectedPlayer) then
                        ...
                        nikeehub(string.format("Coin trade finished (Target: %d, Received: %d)", l_trade_5.targetCoins, l_trade_5.successCoins));
                        return;
                    end;
                end;
            end;
    ...
    startTradeByRarity = function() --[[ Line: 0 ]] --[[ Name:  ]]
        ...
        elseif not l_trade_7.selectedPlayer or not l_trade_7.selectedRarity then
            return nikeehub("\226\154\160 Select player & rarity first!");
        else
            l_trade_7.trading = true;
            l_trade_7.successCount = 0;
            nikeehub("Starting rarity trade (" .. l_trade_7.selectedRarity .. ") with " .. l_trade_7.selectedPlayer);
            ...
            if #v584 == 0 then
                ...
                return nikeehub("No " .. l_trade_7.selectedRarity .. " fishes found");
            else
                ...
                nikeehub("Rarity trade finished (" .. l_trade_7.selectedRarity .. ")");
                return;
            end;
        end;
    end;
    ...
    ThresholdSec:AddButton({
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if l_HumanoidRootPart_5 then
                ...
                nikeehub("Successfully copied your position to clipboard!");
            end;
        end
    });
    ThresholdSec:AddInput({
    ...
    v228:AddToggle({
        ...
        Callback = function(v729) --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            _G.KaitunPanel = v729;
            if v729 then
                if v0.CoreGui:FindFirstChild("NikeeHUB_KaitunPanel") then
                    v0.CoreGui:FindFirstChild("NikeeHUB_KaitunPanel"):Destroy();
                end;
                local l_ScreenGui_2 = Instance.new("ScreenGui");
                l_ScreenGui_2.Name = "NikeeHUB_KaitunPanel";
                ...
                v732.Text = "NIKEEHUB KAITUN PANEL";
                v732.TextSize = 22;
                ...
                local l_NikeeHUB_KaitunPanel_0 = v0.CoreGui:FindFirstChild("NikeeHUB_KaitunPanel");
                if l_NikeeHUB_KaitunPanel_0 then
                    l_NikeeHUB_KaitunPanel_0:Destroy();
                end;
            end;
        end
    });
    v228:AddToggle({
        ...
        Callback = function(v811) --[[ Line: 0 ]] --[[ Name:  ]]
            -- upvalues: v0 (ref)
            local l_NikeeHUB_KaitunPanel_1 = v0.CoreGui:FindFirstChild("NikeeHUB_KaitunPanel");
            if l_NikeeHUB_KaitunPanel_1 then
                local v813 = l_NikeeHUB_KaitunPanel_1:FindFirstChild("MainCard") or l_NikeeHUB_KaitunPanel_1:FindFirstChildWhichIsA("Frame");
                if v813 then
    ...
    v958:AddButton({
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            v960:SetValues(v126());
            nikeehub("Player list refreshed!");
        end
    });
    v958:AddButton({
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if not l_teleportTarget_0 then
                nikeehub("Please select a player first!");
                return;
            else
                ...
                if l_FirstChild_4 and l_FirstChild_4.Character and l_FirstChild_4.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if v963 then
                        ...
                        nikeehub("Teleported to " .. l_FirstChild_4.Name);
                    else
                        nikeehub("Your HumanoidRootPart not found.");
                    end;
                else
                    nikeehub("Target not found or not loaded.");
                end;
                return;
            end;
        end
    ...
    v964:AddButton({
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if not l_teleportTarget_1 then
                nikeehub("Please select a location first!");
                return;
            else
                ...
                if v967 then
                    ...
                    if l_HumanoidRootPart_18 then
                        ...
                        nikeehub("Teleported to " .. l_teleportTarget_1);
                    end;
                end;
                return;
            end;
                            ...
                            if _G.AntiStaff then
                                for _, v976 in ipairs(game:GetService("Players"):GetPlayers()) do
                                    if v976 ~= game.Players.LocalPlayer and l_v972_0[v976:GetRankInGroup(l_v971_0)] then
                                        game.Players.LocalPlayer:Kick("NikeeHUB Detected Staff, Automatically Kicked!");
                                        return;
                                    end;
                                end;
                                task.wait(1);
    ...
    do
        ...
        local function v1005() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if not l_hideident_0 or not l_hideident_0.overhead or not l_hideident_0.titleLabel then
                ...
                l_hideident_0.titleLabel.Text = "NikeeHUB";
                l_hideident_0.gradient.Color = ColorSequence.new({
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 139, 139)),
                ...
                l_hideident_0.header.Text = l_v980_0 ~= "" and l_v980_0 or "Nikee Rawr";
                                                ...
                                                if l_l_Frame_1_FirstChild_0 then
                                                    ...
                                                    if v1022 and v1022:IsA("ImageButton") and v1022.Visible and l_Inside_0.Visible and l_l_Frame_1_FirstChild_0.Visible and v1022.Active then
                                                        pcall(function() --[[ Line: 0 ]] --[[ Name:  ]]
                                                            ...
                                                            nikeehub(string.format("Claimed Reward #%d", l_v1018_0));
                                                        end);
                                                        task.wait(0.7);
                                                    end;
                                                end;
                ...
                if not v1066 then
                    ...
                    elseif _G.WebhookNames and #_G.WebhookNames > 0 and not table.find(_G.WebhookNames, v1066.Name) then
                        ...
                        local v1071 = {
                            embeds = {
                                {
                                    title = "NikeeHUB Webhook | Fish Caught",
                                    ...
                                    image = {
                                        url = getThumbnailURL(v1066.Icon) or "https://i.imgur.com/UQLW63C.png"
                                    },
                                    footer = {
                                        text = "NikeeHUB Webhook",
                                        icon_url = "https://i.imgur.com/UQLW63C.png"
                                    },
                                    timestamp = os.date("!%Y-%m-%dT%H:%M:%S.000Z")
                                }
                            },
                            username = "NikeeHUB Notification!",
                            avatar_url = "https://i.imgur.com/UQLW63C.png"
                        };
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if not l_URL_1 or not l_URL_1:match("discord.com/api/webhooks") then
                    ...
                    embeds = {
                        {
                            ...
                            image = {
                                url = "https://media1.tenor.com/m/kJoHNb7lxJ4AAAAd/bahlil-sunshine.gif"
                            }
                        }
                    },
                    username = "NikeeHUB Notification!",
                ...
                task.spawn(function() --[[ Line: 0 ]] --[[ Name:  ]]
                    ...
                    if l_status_16 then
                        nikeehub("Successfully sent test message!");
                    else
                        nikeehub("Failed to send webhook:", l_result_16);
                    end;
                end);
                return;
            end;
                    ...
                    local function v1179(v1144, v1145) --[[ Line: 0 ]] --[[ Name:  ]]
                        ...
                        if v1146 == "" then
                            ...
                            local v1178 = {
                                ...
                                embeds = {
                                    {
                                        title = "\227\128\162NikeeHUB Webhook | Player Info",
                                        color = 52479,
                                        fields = {
                                            {
                                    ...
                                    },
                                    {
                                        ...
                                        footer = {
                                            text = string.format("NikeeHUB Auto Sync | Every %dm", _G.WebhookFlags.Stats.Delay or 5),
                                            icon_url = "https://i.imgur.com/UQLW63C.png"
                                        },
                                        timestamp = os.date("!%Y-%m-%dT%H:%M:%S.000Z")
                                    }
    ...
    v1193:AddToggle({
        ...
        Callback = function(v1197) --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v1197 and (not _G.DisconnectCustomName or _G.DisconnectCustomName == "") then
                nikeehub("Invalid! Input Hide Identity first.");
                if _G.WebhookFlags and _G.WebhookFlags.Disconnect then
    ...
    local v1210 = loadstring(game:HttpGet("https://raw.githubusercontent.com/NikeeTXC/adbae/refs/heads/main/Addons/2.lua"))();
    ...
    v1211:AddInput({
        ...
        Callback = function(v1213) --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v1213 and v1213:match("^https://discord.com/api/webhooks/") then
                ...
                nikeehub("Server Luck webhook updated!");
            end;
        end
    });
    v1211:AddToggle({
